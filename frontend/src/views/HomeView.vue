  ...
  <div class="home-container">
    ...
    <nav class="navbar">
      <div class="nav-content">
        ...
        <div class="nav-right">
          <div class="nav-links">
            <a href="#" class="nav-link" @click.prevent>About</a>
            <a href="#" class="nav-link" @click.prevent>Features</a>
            <a href="#" class="nav-link" @click.prevent>API</a>
          </div>
